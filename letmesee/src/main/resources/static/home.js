        ...
        success:function(result){
            if(result.code===4000){
                ...
                for(let i=0;i<jsonArr.length;i++){
                    sum += ("<button class=\"btn btn-primary\" type=\"button\" >\n" +
                        jsonArr[i].cname+"\n" +
                        " </button><hr/>")
                }
            ...
            success:function(result){
               ...
               for(var i=0;i<jsonArr.length;i++){
                   sum += "<div class=\"col-sm-6 col-md-4\">\n" +
                       ...
                       "                    <a target='_blank' href='"+jsonArr[i].url+"'><img src=\""+jsonArr[i].url+"\" alt=\"...\"  style='CURSOR: hand;width: 300px;height: 200px;border-radius: 12px'></a>\n" +
